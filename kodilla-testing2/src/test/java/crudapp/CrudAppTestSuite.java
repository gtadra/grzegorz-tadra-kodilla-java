...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://gtadra.github.io/";
    ...
    private void sendTestTaskToTrello(String taskName) throws InterruptedException {
        ...
        driver.findElements(
                ...
                .forEach(foundElement -> {
                    WebElement element = foundElement.findElement(By.xpath(".//button[contains(text(), 'Delete')]"));
                    element.click();
                });
        Thread.sleep(5000);
    }
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("g.tadra@uesa.pl");
        driverTrello.findElement(By.id("password")).sendKeys("##Kodilla2022");
        ...
        driverTrello.findElements(By.xpath(".//div[@title=\"Kodilla Application\"]")).stream()
                .forEach(foundEl -> foundEl.click());


        Thread.sleep(4000);

        System.out.println("Searching for: " + "\"" + taskName + "\"");
